...
/**
 * Represents a button that is connected to a branch.
 */
export class WebWriterGamebookBranchButton extends LitElementWw {
  ...
  /** @internal */
  @property({ type: Array, reflect: false }) accessor elementSubmitted = [];
  /** @internal */
  @property({ type: Array, reflect: false }) accessor submitElements = [];
  /** @internal */
  @property({ type: Number, attribute: true, reflect: true })
  accessor tabIndex = -1;

  /** The Shoelace button element */
