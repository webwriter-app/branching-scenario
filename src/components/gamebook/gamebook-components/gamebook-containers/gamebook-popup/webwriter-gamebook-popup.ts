...
import { WebWriterGamebookBranchButton } from "../../gamebook-branch-button/webwriter-gamebook-branch-button";

//Shoelace
import { SlButton, SlDialog } from "@shoelace-style/shoelace";
import { WebWriterGamebookOptions } from "../../../../options-panel/webwriter-gamebook-options";

@customElement("webwriter-gamebook-popup")
