...
var __decorateElement = (array, flags, name, decorators, target, extra) => {
  ...
  for (var i5 = decorators.length - 1; i5 >= 0; i5--) {
    ...
    if (k3) {
      ctx.static = s6, ctx.private = p3, access = ctx.access = { has: p3 ? (x3) => __privateIn(target, x3) : (x3) => name in x3 };
...
var n = class {
  constructor(t8, e8, o7) {
    if (this._$cssResult$ = true, o7 !== s) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
    this.cssText = t8, this.t = e8;
  }
  get styleSheet() {
    let t8 = this.o;
    const s6 = this.t;
    if (e && void 0 === t8) {
      ...
      e8 && (t8 = o.get(s6)), void 0 === t8 && ((this.o = t8 = new CSSStyleSheet()).replaceSync(this.cssText), e8 && o.set(s6, t8));
    }
    return t8;
  }
  toString() {
...
var i = (t8, ...e8) => {
  const o7 = 1 === t8.length ? t8[0] : e8.reduce((e9, s6, o8) => e9 + ((t9) => {
...
var S = (s6, o7) => {
  if (e) s6.adoptedStyleSheets = o7.map((t8) => t8 instanceof CSSStyleSheet ? t8 : t8.styleSheet);
    ...
    void 0 !== n7 && o8.setAttribute("nonce", n7), o8.textContent = e8.cssText, s6.appendChild(o8);
  }
};
var c = e ? (t8) => t8 : (t8) => t8 instanceof CSSStyleSheet ? ((t9) => {
  let e8 = "";
  for (const s6 of t9.cssRules) e8 += s6.cssText;
  return r(e8);
})(t8) : t8;
...
var b = class extends HTMLElement {
  ...
  static createProperty(t8, s6 = y) {
    if (s6.state && (s6.attribute = false), this._$Ei(), this.elementProperties.set(t8, s6), !s6.noAccessor) {
      const i5 = Symbol(), r8 = this.getPropertyDescriptor(t8, i5, s6);
      void 0 !== r8 && e2(this.prototype, t8, r8);
    }
  }
  static getPropertyDescriptor(t8, s6, i5) {
    const { get: e8, set: h5 } = r2(this.prototype, t8) ?? { get() {
      return this[s6];
    }, set(t9) {
      this[s6] = t9;
    } };
    return { get() {
      ...
      h5.call(this, s7), this.requestUpdate(t8, r8, i5);
  ...
  static finalizeStyles(s6) {
    ...
    if (Array.isArray(s6)) {
      ...
      for (const s7 of e8) i5.unshift(c(s7));
  ...
  _$EC(t8, s6) {
    const i5 = this.constructor.elementProperties.get(t8), e8 = this.constructor._$Eu(t8, i5);
    if (void 0 !== e8 && true === i5.reflect) {
      const r8 = (void 0 !== i5.converter?.toAttribute ? i5.converter : u).toAttribute(s6, i5.type);
      this._$Em = t8, null == r8 ? this.removeAttribute(e8) : this.setAttribute(e8, r8), this._$Em = null;
    }
  }
  _$AK(t8, s6) {
    const i5 = this.constructor, e8 = i5._$Eh.get(t8);
    if (void 0 !== e8 && this._$Em !== e8) {
      const t9 = i5.getPropertyOptions(e8), r8 = "function" == typeof t9.converter ? { fromAttribute: t9.converter } : void 0 !== t9.converter?.fromAttribute ? t9.converter : u;
      this._$Em = e8, this[e8] = r8.fromAttribute(s6, t9.type), this._$Em = null;
    }
  }
...
var B = class _B2 {
  constructor({ strings: t8, _$litType$: i5 }, s6) {
    ...
    this.parts = [];
    let h5 = 0, o7 = 0;
    const n7 = t8.length - 1, r8 = this.parts, [l3, a3] = U(t8, i5);
    ...
    for (; null !== (e8 = I.nextNode()) && r8.length < n7; ) {
      if (1 === e8.nodeType) {
        if (e8.hasAttributes()) for (const t9 of e8.getAttributeNames()) if (t9.endsWith(f2)) {
          const i6 = a3[o7++], s7 = e8.getAttribute(t9).split(v), n8 = /([.?@])?(.*)/.exec(i6);
          r8.push({ type: 1, index: h5, name: n8[2], strings: s7, ctor: "." === n8[1] ? Y : "?" === n8[1] ? Z : "@" === n8[1] ? q : G }), e8.removeAttribute(t9);
        } else t9.startsWith(v) && (r8.push({ type: 6, index: h5 }), e8.removeAttribute(t9));
        if (M.test(e8.tagName)) {
          const t9 = e8.textContent.split(v), i6 = t9.length - 1;
          if (i6 > 0) {
            e8.textContent = c3 ? c3.emptyScript : "";
            for (let s7 = 0; s7 < i6; s7++) e8.append(t9[s7], lt()), I.nextNode(), r8.push({ type: 2, index: ++h5 });
            e8.append(t9[i6], lt());
          }
        }
      } else if (8 === e8.nodeType) if (e8.data === m) r8.push({ type: 2, index: h5 });
      else {
        let t9 = -1;
        for (; -1 !== (t9 = e8.data.indexOf(v, t9 + 1)); ) r8.push({ type: 7, index: h5 }), t9 += v.length - 1;
      }
      h5++;
    }
  }
...
function z(t8, i5, s6 = t8, e8) {
  if (i5 === R) return i5;
  let h5 = void 0 !== e8 ? s6.o?.[e8] : s6.l;
  const o7 = st(i5) ? void 0 : i5._$litDirective$;
  return h5?.constructor !== o7 && (h5?._$AO?.(false), void 0 === o7 ? h5 = void 0 : (h5 = new o7(t8), h5._$AT(t8, s6, e8)), void 0 !== e8 ? (s6.o ??= [])[e8] = h5 : s6.l = h5), void 0 !== h5 && (i5 = z(t8, h5._$AS(t8, i5.values), h5, e8)), i5;
}
var F = class {
  constructor(t8, i5) {
  ...
  u(t8) {
    const { el: { content: i5 }, parts: s6 } = this._$AD, e8 = (t8?.creationScope ?? w).importNode(i5, true);
    I.currentNode = e8;
    let h5 = I.nextNode(), o7 = 0, n7 = 0, r8 = s6[0];
    for (; void 0 !== r8; ) {
      if (o7 === r8.index) {
        let i6;
        2 === r8.type ? i6 = new et(h5, h5.nextSibling, this, t8) : 1 === r8.type ? i6 = new r8.ctor(h5, r8.name, r8.strings, this, t8) : 6 === r8.type && (i6 = new K(h5, this, t8)), this._$AV.push(i6), r8 = s6[++n7];
      }
      o7 !== r8?.index && (h5 = I.nextNode(), o7++);
    }
...
var et = class _et2 {
  ...
  constructor(t8, i5, s6, e8) {
    this.type = 2, this._$AH = D, this._$AN = void 0, this._$AA = t8, this._$AB = i5, this._$AM = s6, this.options = e8, this.v = e8?.isConnected ?? true;
  }
  get parentNode() {
  ...
  $(t8) {
    const { values: i5, _$litType$: s6 } = t8, e8 = "number" == typeof s6 ? this._$AC(t8) : (void 0 === s6.el && (s6.el = B.createElement(N(s6.h, s6.h[0]), this.options)), s6);
    if (this._$AH?._$AD === e8) this._$AH.p(i5);
    else {
      const t9 = new F(e8, this), s7 = t9.u(this.options);
  ...
  k(t8) {
    ...
    const i5 = this._$AH;
    let s6, e8 = 0;
    for (const h5 of t8) e8 === i5.length ? i5.push(s6 = new _et2(this.O(lt()), this.O(lt()), this, this.options)) : s6 = i5[e8], s6._$AI(h5), e8++;
...
var G = class {
  ...
  constructor(t8, i5, s6, e8, h5) {
    this.type = 1, this._$AH = D, this._$AN = void 0, this.element = t8, this.name = i5, this._$AM = e8, this.options = h5, s6.length > 2 || "" !== s6[0] || "" !== s6[1] ? (this._$AH = Array(s6.length - 1).fill(new String()), this.strings = s6) : this._$AH = D;
  }
  _$AI(t8, i5 = this, s6, e8) {
    ...
    if (void 0 === h5) t8 = z(this, t8, i5, 0), o7 = !st(t8) || t8 !== this._$AH && t8 !== R, o7 && (this._$AH = t8);
      ...
      const e9 = t8;
      let n7, r8;
      for (t8 = h5[0], n7 = 0; n7 < h5.length - 1; n7++) r8 = z(this, e9[s6 + n7], i5, n7), r8 === R && (r8 = this._$AH[n7]), o7 ||= !st(r8) || r8 !== this._$AH[n7], r8 === D ? t8 = D : t8 !== D && (t8 += (r8 ?? "") + h5[n7 + 1]), this._$AH[n7] = r8;
    }
    o7 && !e8 && this.j(t8);
  }
  j(t8) {
...
var q = class extends G {
  constructor(t8, i5, s6, e8, h5) {
    super(t8, i5, s6, e8, h5), this.type = 5;
  }
  _$AI(t8, i5 = this) {
    if ((t8 = z(this, t8, i5, 0) ?? D) === R) return;
    const s6 = this._$AH, e8 = t8 === D && s6 !== D || t8.capture !== s6.capture || t8.once !== s6.once || t8.passive !== s6.passive, h5 = t8 !== D && (s6 === D || e8);
    e8 && this.element.removeEventListener(this.name, this, s6), h5 && this.element.addEventListener(this.name, this, t8), this._$AH = t8;
  }
  handleEvent(t8) {
...
var Q = (t8, i5, s6) => {
  const e8 = s6?.renderBefore ?? i5;
  let h5 = e8._$litPart$;
  if (void 0 === h5) {
    const t9 = s6?.renderBefore ?? null;
    e8._$litPart$ = h5 = new et(i5.insertBefore(lt(), t9), t9, void 0, s6 ?? {});
  }
...
var h3 = class extends b {
  ...
  update(t8) {
    ...
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t8), this.o = Q(e8, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
var r4 = (t8 = o4, e8, r8) => {
  ...
  if (void 0 === s6 && globalThis.litPropertyMetadata.set(i5, s6 = /* @__PURE__ */ new Map()), s6.set(r8.name, t8), "accessor" === n7) {
    const { name: o7 } = r8;
    return { set(r9) {
      const n8 = e8.get.call(this);
      e8.set.call(this, r9), this.requestUpdate(o7, n8, t8);
    }, init(e9) {
      return void 0 !== e9 && this.P(o7, void 0, t8), e9;
    } };
  }
  if ("setter" === n7) {
    const { name: o7 } = r8;
    return function(r9) {
      const n8 = this[o7];
      e8.call(this, r9), this.requestUpdate(o7, n8, t8);
    };
  }
  throw Error("Unsupported decorator location: " + n7);
};
function n5(t8) {
  return (e8, o7) => "object" == typeof o7 ? r4(t8, e8, o7) : ((t9, e9, o8) => {
    const r8 = e9.hasOwnProperty(o8);
    return e9.constructor.createProperty(o8, r8 ? { ...t9, wrapped: true } : t9), r8 ? Object.getOwnPropertyDescriptor(e9, o8) : void 0;
  })(t8, e8, o7);
}
...
var e4 = (e8, t8, c6) => (c6.configurable = true, c6.enumerable = true, Reflect.decorate && "object" != typeof t8 && Object.defineProperty(e8, t8, c6), c6);

// src/node_modules/@lit/reactive-element/decorators/query.js
function e5(e8, r8) {
  return (n7, s6, i5) => {
    const o7 = (t8) => t8.renderRoot?.querySelector(e8) ?? null;
    if (r8) {
      const { get: e9, set: r9 } = "object" == typeof s6 ? n7 : i5 ?? (() => {
        const t8 = Symbol();
        return { get() {
          return this[t8];
        }, set(e10) {
      ...
      return e4(n7, s6, { get() {
        let t8 = e9.call(this);
        return void 0 === t8 && (t8 = o7(this), (null !== t8 || this.hasUpdated) && r9.call(this, t8)), t8;
      } });
    }
    return e4(n7, s6, { get() {
      return o7(this);
...
function r6(r8) {
  return (n7, e8) => e4(n7, e8, { async get() {
...
function o5(o7) {
  return (e8, n7) => {
    const { slot: r8, selector: s6 } = o7 ?? {}, c6 = "slot" + (r8 ? `[name=${r8}]` : ":not([name])");
    return e4(e8, n7, { get() {
      const t8 = this.renderRoot?.querySelector(c6), e9 = t8?.assignedElements(o7) ?? [];
      return void 0 === s6 ? e9 : e9.filter((t9) => t9.matches(s6));
    } });
  };
}
...
var e6 = (t8) => (...e8) => ({ _$litDirective$: t8, values: e8 });
var i3 = class {
  constructor(t8) {
  }
  get _$AU() {
  ...
  _$AT(t8, e8, i5) {
    this.t = t8, this._$AM = e8, this.i = i5;
  }
  _$AS(t8, e8) {
    return this.update(t8, e8);
  }
  update(t8, e8) {
...
var Rt = e6(class extends i3 {
  constructor(s6) {
    if (super(s6), s6.type !== t5.ATTRIBUTE || "class" !== s6.name || s6.strings?.length > 2) throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.");
  }
  render(t8) {
  ...
  update(t8, [s6]) {
    ...
    for (const t9 in s6) {
      const r8 = !!s6[t9];
      r8 === this.st.has(t9) || this.nt?.has(t9) || (r8 ? (i5.add(t9), this.st.add(t9)) : (i5.remove(t9), this.st.delete(t9)));
    }
    return R;
  }
});
...
function r7(t8) {
  for (let e8 = t8; e8; e8 = o6(e8)) if (e8 instanceof Element && "none" === getComputedStyle(e8).display) return null;
  for (let e8 = o6(t8); e8; e8 = o6(e8)) {
    if (!(e8 instanceof Element)) continue;
    const t9 = getComputedStyle(e8);
    if ("contents" !== t9.display) {
      if ("static" !== t9.position || "none" !== t9.filter) return e8;
...
var Ft = e6(class extends i3 {
  ...
  update(r8, [e8]) {
    if (e8 === R || e8 === D) return e8;
    const i5 = r8.element, n7 = r8.name;
    if (r8.type === t5.PROPERTY) {
      if (e8 === i5[n7]) return R;
    } else if (r8.type === t5.BOOLEAN_ATTRIBUTE) {
      if (!!e8 === i5.hasAttribute(n7)) return R;
    } else if (r8.type === t5.ATTRIBUTE && i5.getAttribute(n7) === e8 + "") return R;
    return dt(r8), e8;
  }
});
...
function nn(n7, r8, t8) {
  return n7 ? r8(n7) : t8?.(n7);
}
...
var SlTree = class extends ShoelaceElement {
  ...
  handleKeyDown(event) {
    ...
    if (event.composedPath().some((el) => {
      var _a5;
      return ["input", "textarea"].includes((_a5 = el == null ? void 0 : el.tagName) == null ? void 0 : _a5.toLowerCase());
    })) {
      return;
    }
  ...
  handleClick(event) {
    ...
    const isExpandButton = event.composedPath().some((el) => {
      var _a5;
      return (_a5 = el == null ? void 0 : el.classList) == null ? void 0 : _a5.contains("tree-item__expand-button");
    });
  ...
  getFocusableItems() {
    ...
    return items.filter((item) => {
      ...
      if (item.disabled)
        return false;
      const parent = (_a5 = item.parentElement) == null ? void 0 : _a5.closest("[role=treeitem]");
...
var er = (t8, ...r8) => ({ _$litStatic$: r8.reduce((r9, e8, a3) => r9 + ((t9) => {
...
var Ee = (t8) => (r8, ...e8) => {
  ...
  for (; u3 < a3; ) {
    for (n7 = r8[u3]; u3 < a3 && void 0 !== (s6 = e8[u3], o7 = xe(s6)); ) n7 += o7 + r8[++u3], c6 = true;
    u3 !== a3 && l3.push(s6), i5.push(n7), u3++;
  }
  if (u3 === a3 && i5.push(r8[a3]), c6) {
    const t9 = i5.join("$$lit$$");
    void 0 === (r8 = Te.get(t9)) && (i5.raw = i5, Te.set(t9, r8 = i5)), e8 = l3;
  }
  return t8(r8, ...e8);
};
var ke3 = Ee(ke);
      ...
      whenAllDefined.then(() => {
        const intersectionObserver = new IntersectionObserver((entries, observer) => {
          ...
          if (entries[0].intersectionRatio > 0) {
            this.setAriaLabels();
            this.setActiveTab((_a5 = this.getActiveTab()) != null ? _a5 : this.tabs[0], { emitEvents: false });
  ...
  setActiveTab(tab, options) {
    ...
    if (tab !== this.activeTab && !tab.disabled) {
      ...
      this.panels.forEach((el) => {
        var _a5;
        return el.active = el.name === ((_a5 = this.activeTab) == null ? void 0 : _a5.panel);
      });
      this.syncIndicator();
      if (["top", "bottom"].includes(this.placement)) {
...
var le = class extends i3 {
  constructor(i5) {
    if (super(i5), this.it = D, i5.type !== t5.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
  }
  render(t8) {
...
var SlSelect = class extends ShoelaceElement {
  ...
  selectionChanged() {
    ...
    if (this.multiple) {
      ...
      this.value = (_b = (_a5 = this.selectedOptions[0]) == null ? void 0 : _a5.value) != null ? _b : "";
  ...
  get tags() {
    return this.selectedOptions.map((option, index) => {
      if (index < this.maxOptionsVisible || this.maxOptionsVisible <= 0) {
        ...
        return ke`<div @sl-remove=${(e8) => this.handleTagRemove(e8, option)}>
...
var se = e6(class extends i3 {
  ...
  render(t8) {
    return Object.keys(t8).reduce((e8, r8) => {
      const s6 = t8[r8];
      return null == s6 ? e8 : e8 + `${r8 = r8.includes("-") ? r8 : r8.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g, "-$&").toLowerCase()}:${s6};`;
    }, "");
  }
  update(t8, [e8]) {
    const { style: r8 } = t8.element;
    if (void 0 === this.ft) return this.ft = new Set(Object.keys(e8)), this.render(e8);
    for (const t9 of this.ft) null == e8[t9] && (this.ft.delete(t9), t9.includes("-") ? r8.removeProperty(t9) : r8[t9] = null);
    for (const t9 in e8) {
      const s6 = e8[t9];
      if (null != s6) {
        this.ft.add(t9);
        const e9 = "string" == typeof s6 && s6.endsWith(ie);
        t9.includes("-") || e9 ? r8.setProperty(t9, e9 ? s6.slice(0, -11) : s6, e9 ? ee : "") : r8[t9] = s6;
      }
    }
    return R;
  }
...
var SlRadioGroup = class extends ShoelaceElement {
  ...
  handleKeyDown(event) {
    ...
    const checkedRadio = (_a5 = radios.find((radio) => radio.checked)) != null ? _a5 : radios[0];
  ...
  async syncRadioElements() {
    ...
    if (radios.length > 0 && !radios.some((radio) => radio.checked)) {
      if (this.hasButtonGroup) {
        const buttonRadio = (_a5 = radios[0].shadowRoot) == null ? void 0 : _a5.querySelector("button");
        if (buttonRadio) {
...
self.QrCreator = H;
(function(w3) {
  function B3(t8, c6, a3, e8) {
    var b3 = {}, h5 = w3(a3, c6);
    h5.u(t8);
    h5.J();
    e8 = e8 || 0;
    var r8 = h5.h(), d3 = h5.h() + 2 * e8;
    b3.text = t8;
    b3.level = c6;
    b3.version = a3;
    b3.O = d3;
  ...
  function C(t8, c6, a3, e8, b3, h5, r8, d3, g3, x3) {
    function u3(b4, a4, f5, c7, d4, r9, g4) {
      b4 ? (t8.lineTo(a4 + r9, f5 + g4), t8.arcTo(a4, f5, c7, d4, h5)) : t8.lineTo(a4, f5);
    }
    r8 ? t8.moveTo(c6 + h5, a3) : t8.moveTo(c6, a3);
    u3(d3, e8, a3, e8, b3, -h5, 0);
    u3(g3, e8, b3, c6, b3, 0, -h5);
    u3(x3, c6, b3, c6, a3, h5, 0);
    u3(r8, c6, a3, e8, a3, 0, h5);
  }
  function z3(t8, c6, a3, e8, b3, h5, r8, d3, g3, x3) {
  ...
  function A(t8, c6) {
    ...
    if ("string" === typeof a3) t8.fillStyle = a3;
      ...
      var e8 = a3.type, b3 = a3.colorStops;
      a3 = a3.position.map((b4) => Math.round(b4 * c6.size));
      if ("linear-gradient" === e8) var h5 = t8.createLinearGradient.apply(t8, a3);
      else if ("radial-gradient" === e8) h5 = t8.createRadialGradient.apply(t8, a3);
  ...
  function y3(t8, c6) {
    a: {
      var a3 = c6.text, e8 = c6.v, b3 = c6.N, h5 = c6.K, r8 = c6.P;
      b3 = Math.max(1, b3 || 1);
      for (h5 = Math.min(40, h5 || 40); b3 <= h5; b3 += 1) try {
        var d3 = B3(a3, e8, b3, r8);
        break a;
      } catch (J) {
      }
      d3 = void 0;
    ...
    h5 = c6.size / e8;
    a3.beginPath();
    for (r8 = 0; r8 < e8; r8 += 1) for (b3 = 0; b3 < e8; b3 += 1) {
      var g3 = a3, x3 = c6.left + b3 * h5, u3 = c6.top + r8 * h5, p3 = r8, q3 = b3, f5 = d3.a, k3 = x3 + h5, m3 = u3 + h5, D3 = p3 - 1, E3 = p3 + 1, n7 = q3 - 1, l3 = q3 + 1, y4 = Math.floor(Math.min(0.5, Math.max(0, c6.R)) * h5), v4 = f5(p3, q3), I3 = f5(D3, n7), w4 = f5(D3, q3);
      D3 = f5(D3, l3);
      var F3 = f5(p3, l3);
      l3 = f5(E3, l3);
      q3 = f5(
  ...
  function B3() {
    var c6 = [], a3 = 0, e8 = {
      ...
      put: function(b3, h5) {
        for (var a4 = 0; a4 < h5; a4 += 1) e8.m(1 == (b3 >>> h5 - a4 - 1 & 1));
      },
      f: function() {
        return a3;
      },
  ...
  function C(c6, a3) {
    function e8(b4, h6) {
      for (var a4 = -1; 7 >= a4; a4 += 1) if (!(-1 >= b4 + a4 || d3 <= b4 + a4)) for (var c7 = -1; 7 >= c7; c7 += 1) -1 >= h6 + c7 || d3 <= h6 + c7 || (r8[b4 + a4][h6 + c7] = 0 <= a4 && 6 >= a4 && (0 == c7 || 6 == c7) || 0 <= c7 && 6 >= c7 && (0 == a4 || 6 == a4) || 2 <= a4 && 4 >= a4 && 2 <= c7 && 4 >= c7 ? true : false);
    }
    function b3(b4, a4) {
      ...
      for (k3 = 0; k3 < f5.length; k3 += 1) for (m3 = 0; m3 < f5.length; m3 += 1) {
        p3 = f5[k3];
        var q3 = f5[m3];
        if (null == r8[p3][q3]) for (var n7 = -2; 2 >= n7; n7 += 1) for (var l3 = -2; 2 >= l3; l3 += 1) r8[p3 + n7][q3 + l3] = -2 == n7 || 2 == n7 || -2 == l3 || 2 == l3 || 0 == n7 && 0 == l3;
      }
      ...
      if (null == g3) {
        b4 = t8.I(c6, h5);
        f5 = B3();
        for (k3 = 0; k3 < x3.length; k3 += 1) m3 = x3[k3], f5.put(4, 4), f5.put(m3.b(), y3.f(4, c6)), m3.write(f5);
      ...
      for (q3 = d3 - 1; 0 < q3; q3 -= 2) for (6 == q3 && --q3; ; ) {
        for (n7 = 0; 2 > n7; n7 += 1) null == r8[k3][q3 - n7] && (l3 = false, p3 < b4.length && (l3 = 1 == (b4[p3] >>> m3 & 1)), a4(k3, q3 - n7) && (l3 = !l3), r8[k3][q3 - n7] = l3, --m3, -1 == m3 && (p3 += 1, m3 = 7));
        k3 += f5;
        if (0 > k3 || d3 <= k3) {
          k3 -= f5;
          f5 = -f5;
  ...
  function z3(c6, a3) {
    ...
    var e8 = function() {
      ...
      for (var r8 = Array(c6.length - b4 + a3), d3 = 0; d3 < c6.length - b4; d3 += 1) r8[d3] = c6[d3 + b4];
      return r8;
    }(), b3 = { c: function(b4) {
      return e8[b4];
    }, b: function() {
  ...
  C.s = function(c6) {
    for (var a3 = [], e8 = 0; e8 < c6.length; e8++) {
      var b3 = c6.charCodeAt(e8);
      128 > b3 ? a3.push(b3) : 2048 > b3 ? a3.push(192 | b3 >> 6, 128 | b3 & 63) : 55296 > b3 || 57344 <= b3 ? a3.push(224 | b3 >> 12, 128 | b3 >> 6 & 63, 128 | b3 & 63) : (e8++, b3 = 65536 + ((b3 & 1023) << 10 | c6.charCodeAt(e8) & 1023), a3.push(240 | b3 >> 18, 128 | b3 >> 12 & 63, 128 | b3 >> 6 & 63, 128 | b3 & 63));
    }
    return a3;
  };
  var A = { L: 1, M: 0, Q: 3, H: 2 }, y3 = /* @__PURE__ */ function() {
    ...
    var a3 = [
      ...
      for (var a4 = b3.h(), c7 = 0, d3 = 0; d3 < a4; d3 += 1) for (var g3 = 0; g3 < a4; g3 += 1) {
        for (var e9 = 0, t9 = b3.a(d3, g3), p3 = -1; 1 >= p3; p3 += 1) if (!(0 > d3 + p3 || a4 <= d3 + p3)) for (var q3 = -1; 1 >= q3; q3 += 1) 0 > g3 + q3 || a4 <= g3 + q3 || (0 != p3 || 0 != q3) && t9 == b3.a(d3 + p3, g3 + q3) && (e9 += 1);
        5 < e9 && (c7 += 3 + e9 - 5);
      }
      for (d3 = 0; d3 < a4 - 1; d3 += 1) for (g3 = 0; g3 < a4 - 1; g3 += 1) if (e9 = 0, b3.a(d3, g3) && (e9 += 1), b3.a(d3 + 1, g3) && (e9 += 1), b3.a(d3, g3 + 1) && (e9 += 1), b3.a(d3 + 1, g3 + 1) && (e9 += 1), 0 == e9 || 4 == e9) c7 += 3;
      ...
      for (g3 = e9 = 0; g3 < a4; g3 += 1) for (d3 = 0; d3 < a4; d3 += 1) b3.a(d3, g3) && (e9 += 1);
      return c7 += Math.abs(100 * e9 / a4 / a4 - 50) / 5 * 10;
    } };
    return e8;
  }(), v3 = function() {
    for (var c6 = Array(256), a3 = Array(256), e8 = 0; 8 > e8; e8 += 1) c6[e8] = 1 << e8;
    for (e8 = 8; 256 > e8; e8 += 1) c6[e8] = c6[e8 - 4] ^ c6[e8 - 5] ^ c6[e8 - 6] ^ c6[e8 - 8];
    for (e8 = 0; 255 > e8; e8 += 1) a3[c6[e8]] = e8;
    ...
    var a3 = [
      ...
      var e9 = c6(b3, a4);
      if ("undefined" == typeof e9) throw Error("bad rs block @ typeNumber:" + b3 + "/errorCorrectLevel:" + a4);
      b3 = e9.length / 3;
      a4 = [];
      for (var d3 = 0; d3 < b3; d3 += 1) for (var g3 = e9[3 * d3], h5 = e9[3 * d3 + 1], t9 = e9[3 * d3 + 2], p3 = 0; p3 < g3; p3 += 1) {
        var q3 = t9, f5 = {};
        f5.o = h5;
        f5.j = q3;
        a4.push(f5);
  ...
  render() {
    ...
    return ke`
      <canvas
        ...
        class="qr-code"
        role="img"
        aria-label=${((_a5 = this.label) == null ? void 0 : _a5.length) > 0 ? this.label : this.value}
        style=${se({
      width: `${this.size}px`,
      height: `${this.size}px`
    })}
...
var mt = (i5, t8) => {
  ...
  for (const i6 of e8) i6._$AO?.(t8, false), mt(i6, t8);
  return true;
};
var _t = (i5) => {
  let t8, e8;
  do {
    ...
    e8 = t8._$AN, e8.delete(i5), i5 = t8;
  } while (0 === e8?.size);
};
var wt = (i5) => {
  for (let t8; t8 = i5._$AM; i5 = t8) {
    let e8 = t8._$AN;
    if (void 0 === e8) t8._$AN = e8 = /* @__PURE__ */ new Set();
...
function yt(i5, t8 = false, e8 = 0) {
  const s6 = this._$AH, o7 = this._$AN;
  if (void 0 !== o7 && 0 !== o7.size) if (t8) if (Array.isArray(s6)) for (let i6 = e8; i6 < s6.length; i6++) mt(s6[i6], false), _t(s6[i6]);
...
var $t = class extends i3 {
  ...
  _$AT(i5, t8, e8) {
    super._$AT(i5, t8, e8), wt(this), this.isConnected = i5._$AU;
  }
  _$AO(i5, t8 = true) {
...
function hsvToRgb(h5, s6, v3) {
  ...
  const mod = i5 % 6;
  const r8 = [v3, q3, p3, p3, t8, v3][mod];
...
function* oo2(o7, t8, e8 = 1) {
  const i5 = void 0 === t8 ? 0 : o7;
  t8 ??= o7;
  for (let o8 = i5; e8 > 0 ? o8 < t8 : t8 < o8; o8 += e8) yield o8;
}
  ...
  handleKeyDown(event) {
    if (["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Home", "End"].includes(event.key)) {
      ...
      if (isFocusInPagination) {
        this.updateComplete.then(() => {
          var _a5;
          const activePaginationItem = (_a5 = this.shadowRoot) == null ? void 0 : _a5.querySelector(
...
var SlAnimation = class extends ShoelaceElement {
  ...
  get currentTime() {
    var _a5, _b;
    return (_b = (_a5 = this.animation) == null ? void 0 : _a5.currentTime) != null ? _b : 0;
  }
  ...
  async createAnimation() {
    var _a5, _b;
    const easing = (_a5 = dist_exports.easings[this.easing]) != null ? _a5 : this.easing;
  ...
  cancel() {
    var _a5;
    (_a5 = this.animation) == null ? void 0 : _a5.cancel();
  }
  /** Sets the playback time to the end of the animation corresponding to the current playback direction. */
  finish() {
    var _a5;
    (_a5 = this.animation) == null ? void 0 : _a5.finish();
  }
  render() {
    return ke` <slot @slotchange=${this.handleSlotChange}></slot> `;
  }
...
var WebWriterGamebookButton = class extends (_a2 = LitElementWw, _dataTargetId_dec = [n5({ type: Number, reflect: true })], _identifier_dec = [n5({ type: String, attribute: true, reflect: true })], _getNodeEditor_dec = [n5({ attribute: true })], _name_dec = [n5({ type: String, reflect: true })], _size_dec = [n5({ type: String, reflect: true })], _pill_dec = [n5({ type: Boolean, reflect: true })], _outline_dec = [n5({ type: Boolean, reflect: true })], _width_dec = [n5({ type: Number, reflect: true })], _alignment_dec = [n5({ type: String, reflect: true })], _variant_dec = [n5({ type: String, reflect: true })], _tabIndex_dec = [n5({ type: Number, attribute: true, reflect: true })], _button_dec = [e5("sl-button")], _a2) {
  ...
  handleSizeChange(e8) {
    this.size = e8.target.value;
  }
  handlePillChange(e8) {
    this.pill = e8.target.checked;
  }
  handleOutlineChange(e8) {
    this.outline = e8.target.checked;
  }
  handleWidthChange(e8) {
    this.width = e8.target.value;
  }
  handleVariantChange(e8) {
    this.variant = e8.target.value;
  }
        ...
        <div part="options" class="author-only">
          <div class="item">
            ...
            <sl-input
              size="small"
              .value=${this.name}
              @input=${(e8) => this.name = e8.target.value}
            ></sl-input>
          </div>
          <div class="item">
            <p>Size</p>
...
var s3 = class extends Event {
  constructor(s6, t8, e8) {
    super("context-request", { bubbles: true, composed: true }), this.context = s6, this.callback = t8, this.subscribe = e8 ?? false;
  }
};
...
var s4 = class {
  ...
  dispatchRequest() {
    this.host.dispatchEvent(new s3(this.context, this.t, this.subscribe));
  }
};

// node_modules/@lit/context/lib/decorators/consume.js
function c5({ context: c6, subscribe: e8 }) {
  return (o7, n7) => {
    "object" == typeof n7 ? n7.addInitializer(function() {
      new s4(this, { context: c6, callback: (t8) => {
        o7.set.call(this, t8);
      }, subscribe: e8 });
    }) : o7.constructor.addInitializer((o8) => {
      new s4(o8, { context: c6, callback: (t8) => {
        o8[n7] = t8;
      }, subscribe: e8 });
    });
  };
...
var editorState = n6("editorState");
...
var GamebookEditorState = class _GamebookEditorState {
  ...
  setEditorPosition(x3 = -1, y3 = -1) {
    this.editorPosition = { x: x3, y: y3 };
    this.notifyObservers();
  }
...
var _editorStore_dec, _searchInput_dec, _a3, _WebWriterGamebookOptions_decorators, _init3, _searchInput, _editorStore;
_WebWriterGamebookOptions_decorators = [t3("webwriter-gamebook-options")];
var WebWriterGamebookOptions = class extends (_a3 = LitElementWw, _searchInput_dec = [e5("#searchInput")], _editorStore_dec = [c5({ context: editorState, subscribe: true }), n5({ type: Object, attribute: true, reflect: false })], _a3) {
  constructor() {
    super(...arguments);
    __privateAdd(this, _searchInput, __runInitializers(_init3, 8, this)), __runInitializers(_init3, 11, this);
    __privateAdd(this, _editorStore, __runInitializers(_init3, 12, this, new GamebookEditorState("Default"))), __runInitializers(_init3, 15, this);
  }
  static get styles() {
    return i`
      :host {
  ...
  render() {
    const options = (data) => Object.keys(data).filter(
      ...
      (key) => ke`<sl-menu-item
              ...
              ${data[key].class === "page" || data[key].class === "origin" ? ke` <sl-icon slot="prefix" src=${file_default}></sl-icon> ` : data[key].class === "popup" ? ke` <sl-icon slot="prefix" src=${squares_default}></sl-icon>` : data[key].class === "branch" ? ke` <sl-icon slot="prefix" src=${arrows_split_2_default}></sl-icon>` : null}
            </sl-menu-item>
...
__decorateElement(_init3, 4, "searchInput", _searchInput_dec, WebWriterGamebookOptions, _searchInput);
__decorateElement(_init3, 4, "editorStore", _editorStore_dec, WebWriterGamebookOptions, _editorStore);
WebWriterGamebookOptions = __decorateElement(_init3, 0, "WebWriterGamebookOptions", _WebWriterGamebookOptions_decorators, WebWriterGamebookOptions);
__runInitializers(_init3, 1, WebWriterGamebookOptions);

// src/components/gamebook/gamebook-components/gamebook-containers/gamebook-popup/webwriter-gamebook-popup.ts
var _branchesOff_dec, _preventClosing_dec, _noHeader_dec, _titleLabel_dec, _dialog_dec, _slotContent_dec, _pageTitle_dec, _buttons_dec, _tabIndex_dec2, _drawflowNodeId_dec, _a4, _WebWriterGamebookPopup_decorators, _init4, _drawflowNodeId, _tabIndex2, _buttons, _pageTitle, _slotContent, _dialog, _titleLabel, _noHeader, _preventClosing, _branchesOff;
_WebWriterGamebookPopup_decorators = [t3("webwriter-gamebook-popup")];
var WebWriterGamebookPopup = class extends (_a4 = LitElementWw, _drawflowNodeId_dec = [n5({ type: Number, attribute: true, reflect: true })], _tabIndex_dec2 = [n5({ type: Number, attribute: true, reflect: true })], _buttons_dec = [o5({
  flatten: true,
  selector: "webwriter-gamebook-button, webwriter-gamebook-branch-button"
})], _pageTitle_dec = [n5({ type: String, attribute: true, reflect: true })], _slotContent_dec = [o5({
  flatten: true
})], _dialog_dec = [e5("#dialog")], _titleLabel_dec = [n5({ type: String, attribute: true, reflect: true })], _noHeader_dec = [n5({ type: Boolean, attribute: true, reflect: true })], _preventClosing_dec = [n5({ type: Boolean, attribute: true, reflect: true })], _branchesOff_dec = [n5({ type: Number, attribute: true, reflect: true })], _a4) {
  /* 
  ...
  */
  constructor() {
    super();
    __privateAdd(this, _drawflowNodeId, __runInitializers(_init4, 8, this)), __runInitializers(_init4, 11, this);
    __privateAdd(this, _tabIndex2, __runInitializers(_init4, 12, this, -1)), __runInitializers(_init4, 15, this);
    __privateAdd(this, _buttons, __runInitializers(_init4, 16, this)), __runInitializers(_init4, 19, this);
    __privateAdd(this, _pageTitle, __runInitializers(_init4, 20, this)), __runInitializers(_init4, 23, this);
    __privateAdd(this, _slotContent, __runInitializers(_init4, 24, this)), __runInitializers(_init4, 27, this);
    __privateAdd(this, _dialog, __runInitializers(_init4, 28, this)), __runInitializers(_init4, 31, this);
    __privateAdd(this, _titleLabel, __runInitializers(_init4, 32, this, "Dialog")), __runInitializers(_init4, 35, this);
    __privateAdd(this, _noHeader, __runInitializers(_init4, 36, this, false)), __runInitializers(_init4, 39, this);
    __privateAdd(this, _preventClosing, __runInitializers(_init4, 40, this)), __runInitializers(_init4, 43, this);
    __privateAdd(this, _branchesOff, __runInitializers(_init4, 44, this, -1)), __runInitializers(_init4, 47, this);
...
__decorateElement(_init4, 4, "drawflowNodeId", _drawflowNodeId_dec, WebWriterGamebookPopup, _drawflowNodeId);
__decorateElement(_init4, 4, "tabIndex", _tabIndex_dec2, WebWriterGamebookPopup, _tabIndex2);
__decorateElement(_init4, 4, "buttons", _buttons_dec, WebWriterGamebookPopup, _buttons);
__decorateElement(_init4, 4, "pageTitle", _pageTitle_dec, WebWriterGamebookPopup, _pageTitle);
__decorateElement(_init4, 4, "slotContent", _slotContent_dec, WebWriterGamebookPopup, _slotContent);
__decorateElement(_init4, 4, "dialog", _dialog_dec, WebWriterGamebookPopup, _dialog);
__decorateElement(_init4, 4, "titleLabel", _titleLabel_dec, WebWriterGamebookPopup, _titleLabel);
__decorateElement(_init4, 4, "noHeader", _noHeader_dec, WebWriterGamebookPopup, _noHeader);
__decorateElement(_init4, 4, "preventClosing", _preventClosing_dec, WebWriterGamebookPopup, _preventClosing);
__decorateElement(_init4, 4, "branchesOff", _branchesOff_dec, WebWriterGamebookPopup, _branchesOff);
WebWriterGamebookPopup = __decorateElement(_init4, 0, "WebWriterGamebookPopup", _WebWriterGamebookPopup_decorators, WebWriterGamebookPopup);
__runInitializers(_init4, 1, WebWriterGamebookPopup);
export {
  WebWriterGamebookPopup
};
