...
var _slotContent_dec, _buttons_dec, _slotElement_dec, _branchesOff_dec, _originPage_dec, _pageTitle_dec, _drawflowNodeId_dec, _tabIndex_dec2, _a4, _WebWriterGamebookPage_decorators, _init4, _tabIndex2, _drawflowNodeId, _pageTitle, _originPage, _branchesOff, _slotElement, _buttons, _slotContent;
_WebWriterGamebookPage_decorators = [t3("webwriter-gamebook-page")];
var WebWriterGamebookPage = class extends (_a4 = LitElementWw, _tabIndex_dec2 = [n5({ type: Number, attribute: true, reflect: true })], _drawflowNodeId_dec = [n5({ type: Number, attribute: true, reflect: true })], _pageTitle_dec = [n5({ type: String, attribute: true, reflect: true })], _originPage_dec = [n5({ type: Number, attribute: true, reflect: true })], _branchesOff_dec = [n5({ type: Number, attribute: true, reflect: true })], _slotElement_dec = [e5("slot")], _buttons_dec = [o5({
  flatten: true,
  ...
  */
  constructor() {
    super();
    __privateAdd(this, _tabIndex2, __runInitializers(_init4, 8, this, -1)), __runInitializers(_init4, 11, this);
    __privateAdd(this, _drawflowNodeId, __runInitializers(_init4, 12, this)), __runInitializers(_init4, 15, this);
    __privateAdd(this, _pageTitle, __runInitializers(_init4, 16, this)), __runInitializers(_init4, 19, this);
    __privateAdd(this, _originPage, __runInitializers(_init4, 20, this)), __runInitializers(_init4, 23, this);
    __privateAdd(this, _branchesOff, __runInitializers(_init4, 24, this, -1)), __runInitializers(_init4, 27, this);
    __privateAdd(this, _slotElement, __runInitializers(_init4, 28, this)), __runInitializers(_init4, 31, this);
    __privateAdd(this, _buttons, __runInitializers(_init4, 32, this)), __runInitializers(_init4, 35, this);
    __privateAdd(this, _slotContent, __runInitializers(_init4, 36, this)), __runInitializers(_init4, 39, this);
...
__decorateElement(_init4, 4, "tabIndex", _tabIndex_dec2, WebWriterGamebookPage, _tabIndex2);
__decorateElement(_init4, 4, "drawflowNodeId", _drawflowNodeId_dec, WebWriterGamebookPage, _drawflowNodeId);
__decorateElement(_init4, 4, "pageTitle", _pageTitle_dec, WebWriterGamebookPage, _pageTitle);
__decorateElement(_init4, 4, "originPage", _originPage_dec, WebWriterGamebookPage, _originPage);
__decorateElement(_init4, 4, "branchesOff", _branchesOff_dec, WebWriterGamebookPage, _branchesOff);
__decorateElement(_init4, 4, "slotElement", _slotElement_dec, WebWriterGamebookPage, _slotElement);
__decorateElement(_init4, 4, "buttons", _buttons_dec, WebWriterGamebookPage, _buttons);
__decorateElement(_init4, 4, "slotContent", _slotContent_dec, WebWriterGamebookPage, _slotContent);
WebWriterGamebookPage = __decorateElement(_init4, 0, "WebWriterGamebookPage", _WebWriterGamebookPage_decorators, WebWriterGamebookPage);
__runInitializers(_init4, 1, WebWriterGamebookPage);
export {
  WebWriterGamebookPage
};
