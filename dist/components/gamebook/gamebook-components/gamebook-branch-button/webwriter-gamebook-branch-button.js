...
function n4(t7) {
  return (e7, o6) => "object" == typeof o6 ? r3(t7, e7, o6) : ((t8, e8, o7) => {
...
function r5(r8) {
  return (n6, e7) => e3(n6, e7, { async get() {
...
var t4 = globalThis;
var e5 = t4.ShadowRoot && (void 0 === t4.ShadyCSS || t4.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype;
var s2 = Symbol();
...
var r6 = (t22) => new n5("string" == typeof t22 ? t22 : t22 + "", void 0, s2);
var S3 = (s22, o42) => {
...
var c4 = e5 ? (t22) => t22 : (t22) => t22 instanceof CSSStyleSheet ? ((t32) => {
  let e42 = "";
...
var SlTree = class extends ShoelaceElement {
  ...
  handleKeyDown(event) {
    ...
    if (event.composedPath().some((el) => {
      var _a3;
      return ["input", "textarea"].includes((_a3 = el == null ? void 0 : el.tagName) == null ? void 0 : _a3.toLowerCase());
    })) {
      return;
    }
  ...
  handleClick(event) {
    ...
    const isExpandButton = event.composedPath().some((el) => {
      var _a3;
      return (_a3 = el == null ? void 0 : el.classList) == null ? void 0 : _a3.contains("tree-item__expand-button");
    });
  ...
  getFocusableItems() {
    ...
    return items.filter((item) => {
      ...
      if (item.disabled)
        return false;
      const parent = (_a3 = item.parentElement) == null ? void 0 : _a3.closest("[role=treeitem]");
  ...
  setActiveTab(tab, options) {
    ...
    if (tab !== this.activeTab && !tab.disabled) {
      ...
      this.panels.forEach((el) => {
        var _a3;
        return el.active = el.name === ((_a3 = this.activeTab) == null ? void 0 : _a3.panel);
      });
      this.syncIndicator();
      if (["top", "bottom"].includes(this.placement)) {
...
var SlSelect = class extends ShoelaceElement {
  ...
  selectionChanged() {
    ...
    if (this.multiple) {
      ...
      this.value = (_b = (_a3 = this.selectedOptions[0]) == null ? void 0 : _a3.value) != null ? _b : "";
...
var SlRadioGroup = class extends ShoelaceElement {
  ...
  handleKeyDown(event) {
    ...
    const checkedRadio = (_a3 = radios.find((radio) => radio.checked)) != null ? _a3 : radios[0];
  ...
  async syncRadioElements() {
    ...
    if (radios.length > 0 && !radios.some((radio) => radio.checked)) {
      if (this.hasButtonGroup) {
        const buttonRadio = (_a3 = radios[0].shadowRoot) == null ? void 0 : _a3.querySelector("button");
        if (buttonRadio) {
  ...
  render() {
    ...
    return ke`
      <canvas
        ...
        class="qr-code"
        role="img"
        aria-label=${((_a3 = this.label) == null ? void 0 : _a3.length) > 0 ? this.label : this.value}
        style=${se({
      width: `${this.size}px`,
      height: `${this.size}px`
    })}
...
var SubmenuController = class {
  constructor(host, hasSlotController, localize) {
    ...
    this.handleClick = (event) => {
      ...
      if (event.target === this.host) {
        event.preventDefault();
        event.stopPropagation();
      } else if (event.target instanceof Element && (event.target.tagName === "sl-menu-item" || ((_a3 = event.target.role) == null ? void 0 : _a3.startsWith("menuitem")))) {
        this.disableSubmenu();
      }
    };
    this.handleFocusOut = (event) => {
  ...
  updateSkidding() {
    var _a3;
    if (!((_a3 = this.host.parentElement) == null ? void 0 : _a3.computedStyleMap)) {
      return;
    }
...
var SlMenu = class extends ShoelaceElement {
  ...
  handleClick(event) {
    ...
    const target = event.composedPath().find((el) => {
      var _a3;
      return menuItemTypes.includes(((_a3 = el == null ? void 0 : el.getAttribute) == null ? void 0 : _a3.call(el, "role")) || "");
    });
    if (!target)
      return;
    const item = target;
  ...
  isMenuItem(item) {
    var _a3;
    return item.tagName.toLowerCase() === "sl-menu-item" || ["menuitem", "menuitemcheckbox", "menuitemradio"].includes((_a3 = item.getAttribute("role")) != null ? _a3 : "");
  }
...
function getTabbableBoundary(root) {
  ...
  const start = (_a3 = tabbableElements[0]) != null ? _a3 : null;
  const end = (_b = tabbableElements[tabbableElements.length - 1]) != null ? _b : null;
  return { start, end };
}
function getSlottedChildrenOutsideRootElement(slotElement, root) {
  var _a3;
  return ((_a3 = slotElement.getRootNode({ composed: true })) == null ? void 0 : _a3.host) !== root;
}
  ...
  constructor(element) {
    ...
    this.handleKeyDown = (event) => {
      ...
      while (true) {
        ...
        (_a3 = this.currentFocus) == null ? void 0 : _a3.focus({ preventScroll: false });
...
var SlDropdown = class extends ShoelaceElement {
  constructor() {
    ...
    this.handleDocumentKeyDown = (event) => {
      ...
      if (event.key === "Tab") {
        if (this.open && ((_a3 = document.activeElement) == null ? void 0 : _a3.tagName.toLowerCase()) === "sl-menu-item") {
          event.preventDefault();
          this.hide();
          this.focusOnTrigger();
          return;
...
var SlColorPicker = class extends ShoelaceElement {
  ...
  blur() {
    ...
    if ((_a3 = this.dropdown) == null ? void 0 : _a3.open) {
      this.dropdown.hide();
    }
  }
  ...
  handleKeyDown(event) {
    if (["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Home", "End"].includes(event.key)) {
      ...
      if (isFocusInPagination) {
        this.updateComplete.then(() => {
          var _a3;
          const activePaginationItem = (_a3 = this.shadowRoot) == null ? void 0 : _a3.querySelector(
...
var SlAnimation = class extends ShoelaceElement {
  ...
  get currentTime() {
    var _a3, _b;
    return (_b = (_a3 = this.animation) == null ? void 0 : _a3.currentTime) != null ? _b : 0;
  }
  ...
  async createAnimation() {
    var _a3, _b;
    const easing = (_a3 = dist_exports.easings[this.easing]) != null ? _a3 : this.easing;
  ...
  cancel() {
    var _a3;
    (_a3 = this.animation) == null ? void 0 : _a3.cancel();
  }
  /** Sets the playback time to the end of the animation corresponding to the current playback direction. */
  finish() {
    var _a3;
    (_a3 = this.animation) == null ? void 0 : _a3.finish();
  }
  render() {
    return ke` <slot @slotchange=${this.handleSlotChange}></slot> `;
  }
...
var _button_dec, _tabIndex_dec, _submitElements_dec, _elementSubmitted_dec, _disabled_dec, _variant_dec, _alignment_dec, _width_dec, _outline_dec, _pill_dec, _size_dec, _name_dec, _getNodeEditor_dec, _identifier_dec, _dataTargetId_dec, _a2, _WebWriterGamebookBranchButton_decorators, _init2, _dataTargetId, _identifier, _getNodeEditor, _name, _size, _pill, _outline, _width, _alignment, _variant, _disabled, _elementSubmitted, _submitElements, _tabIndex, _button;
_WebWriterGamebookBranchButton_decorators = [t2("webwriter-gamebook-branch-button")];
var WebWriterGamebookBranchButton = class extends (_a2 = LitElementWw, _dataTargetId_dec = [n4({ type: Number, reflect: true })], _identifier_dec = [n4({ type: String, attribute: true, reflect: true })], _getNodeEditor_dec = [n4({ attribute: true })], _name_dec = [n4({ type: String, reflect: true })], _size_dec = [n4({ type: String, reflect: true })], _pill_dec = [n4({ type: Boolean, reflect: true })], _outline_dec = [n4({ type: Boolean, reflect: true })], _width_dec = [n4({ type: Number, reflect: true })], _alignment_dec = [n4({ type: String, reflect: true })], _variant_dec = [n4({ type: String, reflect: true })], _disabled_dec = [n4({ type: Boolean, reflect: false })], _elementSubmitted_dec = [n4({ type: Object, reflect: false })], _submitElements_dec = [n4({ type: Object, reflect: false })], _tabIndex_dec = [n4({ type: Number, attribute: true, reflect: true })], _button_dec = [e4("sl-button")], _a2) {
  constructor() {
    super(...arguments);
    ...
    __privateAdd(this, _disabled, __runInitializers(_init2, 48, this, false)), __runInitializers(_init2, 51, this);
    __privateAdd(this, _elementSubmitted, __runInitializers(_init2, 52, this, [])), __runInitializers(_init2, 55, this);
    __privateAdd(this, _submitElements, __runInitializers(_init2, 56, this, [])), __runInitializers(_init2, 59, this);
    __privateAdd(this, _tabIndex, __runInitializers(_init2, 60, this, -1)), __runInitializers(_init2, 63, this);
    __privateAdd(this, _button, __runInitializers(_init2, 64, this)), __runInitializers(_init2, 67, this);
  }
...
_button = new WeakMap();
__decorateElement(_init2, 4, "dataTargetId", _dataTargetId_dec, WebWriterGamebookBranchButton, _dataTargetId);
__decorateElement(_init2, 4, "identifier", _identifier_dec, WebWriterGamebookBranchButton, _identifier);
__decorateElement(_init2, 4, "getNodeEditor", _getNodeEditor_dec, WebWriterGamebookBranchButton, _getNodeEditor);
__decorateElement(_init2, 4, "name", _name_dec, WebWriterGamebookBranchButton, _name);
__decorateElement(_init2, 4, "size", _size_dec, WebWriterGamebookBranchButton, _size);
__decorateElement(_init2, 4, "pill", _pill_dec, WebWriterGamebookBranchButton, _pill);
__decorateElement(_init2, 4, "outline", _outline_dec, WebWriterGamebookBranchButton, _outline);
__decorateElement(_init2, 4, "width", _width_dec, WebWriterGamebookBranchButton, _width);
__decorateElement(_init2, 4, "alignment", _alignment_dec, WebWriterGamebookBranchButton, _alignment);
__decorateElement(_init2, 4, "variant", _variant_dec, WebWriterGamebookBranchButton, _variant);
__decorateElement(_init2, 4, "disabled", _disabled_dec, WebWriterGamebookBranchButton, _disabled);
__decorateElement(_init2, 4, "elementSubmitted", _elementSubmitted_dec, WebWriterGamebookBranchButton, _elementSubmitted);
__decorateElement(_init2, 4, "submitElements", _submitElements_dec, WebWriterGamebookBranchButton, _submitElements);
__decorateElement(_init2, 4, "tabIndex", _tabIndex_dec, WebWriterGamebookBranchButton, _tabIndex);
__decorateElement(_init2, 4, "button", _button_dec, WebWriterGamebookBranchButton, _button);
WebWriterGamebookBranchButton = __decorateElement(_init2, 0, "WebWriterGamebookBranchButton", _WebWriterGamebookBranchButton_decorators, WebWriterGamebookBranchButton);
__runInitializers(_init2, 1, WebWriterGamebookBranchButton);
export {
