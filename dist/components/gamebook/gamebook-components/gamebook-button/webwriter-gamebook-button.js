...
_WebWriterGamebookButton_decorators = [t2("webwriter-gamebook-button")];
var WebWriterGamebookButton = class extends (_a2 = LitElementWw, _dataTargetId_dec = [n4({ type: Number, reflect: true })], _identifier_dec = [n4({ type: String, attribute: true, reflect: true })], _getNodeEditor_dec = [n4({ attribute: true })], _name_dec = [n4({ type: String, reflect: true })], _size_dec = [n4({ type: String, reflect: true })], _pill_dec = [n4({ type: Boolean, reflect: true })], _outline_dec = [n4({ type: Boolean, reflect: true })], _width_dec = [n4({ type: Number, reflect: true })], _alignment_dec = [n4({ type: String, reflect: true })], _variant_dec = [n4({ type: String, reflect: true })], _tabIndex_dec = [n4({ type: Number, attribute: true, reflect: true })], _button_dec = [e4("sl-button")], _a2) {
  constructor() {
    super(...arguments);
